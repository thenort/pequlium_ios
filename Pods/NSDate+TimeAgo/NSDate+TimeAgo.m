...
- (NSString *)timeAgo
{
    ...
    else if(deltaSeconds < 60)
    {
        ...
        return [self getLocaleFormatUnderscoresWithValue:deltaSeconds];
    }
    ...
    else if (deltaMinutes < 60)
    {
        ...
        return [self getLocaleFormatUnderscoresWithValue:deltaMinutes];
    ...
    else if (deltaMinutes < (24 * 60))
    {
        ...
        return [self getLocaleFormatUnderscoresWithValue:minutes];
    }
